...
public class BodyEmailEditText extends EditText {

    private OnEnableListener _enableListner;
    private String fontName;
    private boolean IsLableShow = false;

    public BodyEmailEditText(Context context, String customFont) {
        super(context);
        if (!isInEditMode()) {
    ...
    public BodyEmailEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
