...
public class BodyPasswordEditText extends EditText {

    private OnEnableListener _enableListner;
    private String fontName;
    private boolean IsLableShow = false;

    public BodyPasswordEditText(Context context, String customFont) {
        super(context);
        if (!isInEditMode()) {
    ...
    public BodyPasswordEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
