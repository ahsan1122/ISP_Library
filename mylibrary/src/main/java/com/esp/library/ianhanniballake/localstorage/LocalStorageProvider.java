...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.errorcreatingnewfile) + " " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            tempFile = File.createTempFile(getContext().getString(R.string.thumbnail), null, getContext().getCacheDir());
            out = new FileOutputStream(tempFile);
            bitmap.compress(Bitmap.CompressFormat.PNG, 90, out);
        } catch (IOException e) {
            Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.errorwritingthumbnail), e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageProvider.class.getSimpleName(), getContext().getString(R.string.errorclosingthumbnail), e);
                }
        }
